...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  if (!$props.alignRight) {
    _push(`<div class="flex lg:justify-end mx-10 lg:ml-0 lg:-mr-16"><div class="lg:text-right">`);
    ssrRenderSlot(_ctx.$slots, "default", {}, null, _push, _parent);
    _push(`</div></div>`);
  } else {
    _push(`<div class="hidden lg:block"></div>`);
  }
  _push(`<div class="hidden lg:flex justify-center"><img class="${ssrRenderClass([$props.alignRight ? "" : "scale-x-[-1]"])}"${ssrRenderAttr("src", `/images/separator_${$props.sepSize}.svg`)} alt=""></div>`);
  if ($props.alignRight) {
    _push(`<div class="flex justify-start mx-10 lg:mr-0 lg:-ml-16"><div class="text-left">`);
    ssrRenderSlot(_ctx.$slots, "default", {}, null, _push, _parent);
    _push(`</div></div>`);
  } else {
    _push(`<!---->`);
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  ssrRenderList(["controller", "code", "warhammer", "twitch", "youtube"], (icon) => {
    _push(`<img class="w-10 xl:w-20"${ssrRenderAttr("src", `/icons/${icon}.svg`)} alt="">`);
  });
...
//# sourceMappingURL=index-BhraUamv.mjs.map
